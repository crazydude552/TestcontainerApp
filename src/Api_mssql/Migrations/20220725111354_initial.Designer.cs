...
namespace Api_mssql.Migrations
{
    ...
    [Migration("20220725111354_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api_mssql.Models.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Api_mssql.Models.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Api_mssql.Models.Book", b =>
                {
                    b.HasOne("Api_mssql.Models.Author", "Author")
                        .WithMany("Books")
